...
ROLE_DEFAULTS = {
    ...
    "Editor": [VIEW_OWN_RECORDS, CREATE_RECORDS, EDIT_OWN_RECORDS, IMPORT_EXCEL, EXPORT_DATA, VIEW_JIRA],
    "Viewer": [VIEW_OWN_RECORDS, EXPORT_DATA, VIEW_JIRA],
}
